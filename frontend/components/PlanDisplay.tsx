...
/**
 * Displays a travel plan in a friendly format.  
 * Each day is rendered with its date, description and activities.
 */
    ...
    <div className="space-y-8">
      {plan.tagesplan.map((day) => (
        <div key={day.tag} className="p-6 bg-white rounded-lg shadow">
          ...
          {day.restaurant && (
            <p className="mt-2"><span className="font-medium">Restaurant:</span> {day.restaurant}</p>
          )}
          {day.bemerkung && (
