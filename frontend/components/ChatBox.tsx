...
interface ChatBoxProps {
  /**
   * Initial system messages or plan summary that should appear when the chat loads.
   */
  initialMessages?: Message[];
  /**
   * Callback invoked when the user sends a new message.  
   * It should return a promise that resolves to the assistant response.
   */
  ...
  return (
    <div className="border rounded-lg p-4 bg-white shadow-sm">
      <div className="h-64 overflow-y-auto space-y-2 mb-4">
        ...
        {loading && (
          <div className="text-sm text-gray-500">GPT schreibt…</div>
        )}
      </div>
